...
const { DeveloperIds } = require("../../configuration/config.json");
...
module.exports = {
    ...
    callback: async (interaction) => {
        ...
        if (command.perms.devOnly && !DeveloperIds.includes(user.id)) return interaction.reply({ content: `This command is devOnly!`, ephemeral: true });
