...
const { ClientPrefix, DeveloperIds } = require("../../configuration/config.json");
...
module.exports = {
    ...
    callback: async (message) => {
        ...
        if (command.perms.devOnly && !DeveloperIds.includes(author.id)) return message.reply({ content: `This command is devOnly!` });
